...
<head>
  ...
  @include('teachers.layout.partials.header')
  @yield('css')
  @toastr_css
</head>
...
<div class="wrapper">
      ...
      <!-- Sidebar -->
      @include('teachers.layout.partials.sidebar')

      <div id="content-o">

          @include('teachers.layout.partials.topbar')
...
@include('teachers.layout.partials.footer')
@yield('scripts')
@toastr_js
@toastr_render
<script>
