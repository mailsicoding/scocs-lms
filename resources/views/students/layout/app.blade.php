...
<head>
  ...
  @include('students.layout.partials.header')
  @yield('css')
  @toastr_css
</head>
...
<div class="wrapper">
      ...
      <!-- Sidebar -->
      @include('students.layout.partials.sidebar')

      <div id="content-o">

          @include('students.layout.partials.topbar')
...
@include('students.layout.partials.footer')
@yield('scripts')
@toastr_js
@toastr_render
<script>
