                    ...
                    <li>
                        <a href="#" role="button"
                            style="padding:10px;position:relative;bottom:10px;background-color:#fff"><img
                                ...
                                style="display: inline-block;height:40px;width:40px;margin-right:10px"><b>{{ Auth::guard('student')->user()->first_name.' '.Auth::guard('student')->user()->last_name }}</b>

                        </a>
                    </li>
                    <li>
                        <a tabindex="-1" href="#" onclick="document.querySelector('#logout-form').submit()"><b><i class="icon-signout"></i> &nbsp;Logout</b></a>
                        <form action="{{ route('student.logout') }}" id="logout-form" method="post">@csrf</form>
                    </li>
                </ul>
            </div>