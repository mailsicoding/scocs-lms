<nav id="sidebar-o">
    ...
    <ul class="list-unstyled components">
        ...
        <li class="active"> <a href="http://localhost/projects/scocs-lms/admin/dashboard"><i
                    class="icon-home"></i>&nbsp;Dashboard <i class="icon-chevron-right pull-right"></i></a> </li>
        <li class="">
            <a href="http://localhost/projects/scocs-lms/admin/departments"><i class="icon-building"></i> Departments <i
                    class="icon-chevron-right pull-right"></i></a>
        </li>
        <li class="">
            <a href="http://localhost/projects/scocs-lms/admin/classes"><i class="icon-group"></i> Classes <i
                    class="icon-chevron-right pull-right"></i></a>
        </li>
        <li class="">
            <a href="http://localhost/projects/scocs-lms/admin/courses"><i class="icon-book"></i> Courses <i
                    class="icon-chevron-right pull-right"></i></a>
        </li>
        <li class="">
            <a href="http://localhost/projects/scocs-lms/admin/students"><i class="icon-group"></i> Students <i
                    class="icon-chevron-right pull-right"></i></a>
        </li>
        <li class="">
            <a href="http://localhost/projects/scocs-lms/admin/teachers"><i class="icon-group"></i> Teachers <i
                    class="icon-chevron-right pull-right"></i></a>
        </li>
        <li class="">
